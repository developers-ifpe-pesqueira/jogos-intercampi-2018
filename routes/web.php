...
Route::get('/relacao/campus_modalidade', 'HomeController@relacao_campus_modalidade')->name('relacao.campus.modalidade');
Route::post('/relacao/campus_modalidade', 'HomeController@relacao_campus_modalidade_pdf');

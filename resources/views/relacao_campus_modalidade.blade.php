...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('relacao.campus') }}"><i class="fa fa-fw fa-volleyball-ball"></i> por Campus/Modalidade</a></li>
    </ol>
@stop
...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Relação de inscritos por Campus/Modalidade</h3>
    </div>
    <div class="box-body">
        @if ($errors->any())
        ...
        @endif
        <form action="{{ route('relacao.campus.modalidade') }}" method="POST" target="_blank">
            {{ csrf_field() }}
